...
function Footer() {
    return (
        <footer className=" bg-red-900/90 flex p-5 justify-end w-full flex gap-10">
            <div className="place-items-center justify-center gap-10 flex h-full">
                ...
                <ul className="flex flex-col justify-center h-full">
                    <h1 className="text-2xl  font-medium  italic   text-amber-300 ">Office Of The President</h1>
